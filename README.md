...
- 🔧 修复签名模块：endesive API 兼容性问题
- 🔧 修复加密模块：pypdf API 参数名变更
- 🔧 修复书签模块：Windows 控制台编码问题
- 🔧 修复水印模块：图片水印格式转换问题
- 🧪 测试用例：343 个全部通过

### v1.4.0 (2026-04-14)

- ✨ PDF/A 转换：支持 PDF/A-1b/2b/3b 存档格式转换与验证
- 🔒 安全审计：检测 JavaScript/嵌入文件/可疑链接等安全风险
- 📑 书签管理：添加/删除/提取 PDF 书签
- 🔗 链接管理：提取/添加/删除 PDF 超链接
- 💬 注释管理：添加/删除/提取 PDF 注释（文本/高亮/下划线）
- 🧪 测试扩展：343 个测试用例
